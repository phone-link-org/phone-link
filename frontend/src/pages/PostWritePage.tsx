...
const categories: Category[] = [
  { id: "1", name: "번호이동", description: "번호이동 관련 정보" },
  { id: "2", name: "기기변경", description: "기기변경 관련 정보" },
  { id: "3", name: "성지", description: "성지폰 관련 정보" },
  { id: "4", name: "요금제", description: "요금제 비교 및 정보" },
  { id: "5", name: "할인혜택", description: "할인 혜택 정보" },
  { id: "6", name: "중고폰", description: "중고폰 관련 정보" },
];
...
const PostWritePage: React.FC = () => {
  ...
  const editor = useEditor({
    ...
    content: "<p>글 내용을 작성해주세요...</p>",
    editorProps: {
      attributes: {
        class:
          "prose prose-lg max-w-none dark:prose-invert focus:outline-none min-h-[400px] p-4 text-gray-900 dark:text-white",
      },
    },
  });
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 mt-16">
      ...
      <div className="bg-white dark:bg-[#292929] rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full p-3 border border-gray-300 dark:border-gray-500 rounded-lg bg-white dark:bg-[#292929] text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-light dark:focus:ring-primary-dark focus:border-transparent outline-none"
          >
        ...
        {/* 태그 입력 */}
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">태그 (쉼표로 구분)</label>
          <input
            type="text"
            value={tags}
            onChange={(e) => setTags(e.target.value)}
            placeholder="예: 번호이동, MNP, 통신사"
            className="w-full p-3 border border-gray-300 dark:border-gray-500 rounded-lg bg-white dark:bg-[#292929] text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-primary-light dark:focus:ring-primary-dark focus:border-transparent outline-none"
          />
        </div>
      </div>

      {/* 에디터 툴바 */}
      <div className="bg-white dark:bg-[#292929] rounded-lg shadow-md p-2 sm:p-3 mb-4">
      ...
      <div className="flex justify-end gap-2">
        ...
        <button
          onClick={handleSave}
          className="bg-primary-light dark:bg-primary-dark text-white px-6 py-2 rounded-lg hover:opacity-90 transition-opacity flex items-center gap-2"
        >
